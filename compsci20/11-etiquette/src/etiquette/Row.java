...
//	/**
//	 * (depreciated) Finds the first open seat farthest from occupied seats.
//	 * However, if any seats tie in distance, the first seat closest to an
//	 * edge is chosen. This solution is depreciated due to a misinterpretation
//	 * of the problem.
//	 * 
//	 * @return Index of farthest seat.
//	 */
...
//		int max = 0,
//			maxIndex = 0,
//			seen = 0;		// # of times max has been seen
//		
//		for (int i = 0; i != dist.length; ++i) {
//			if (dist[i] == max)
//				++seen;
...
//		}
//		
//		// more than 1 max; one or more ties
//		if (seen > 1)
//			maxIndex = getEndSeat();
//		
//		return maxIndex;
